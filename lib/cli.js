...
function Cli(config, modeling, elementRegistry, commandStack) {
  ...
  this.registerCommands({
    ...
    append: {
      args: [ params.Shape('source'), params.String('type'), params.Delta('delta', { dx: 100, dy: 0 }) ],
...
Cli.$inject = [ 'config', 'modeling', 'elementRegistry', 'commandStack' ];
